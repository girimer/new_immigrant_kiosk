  ...
  return (
    <div>
      ...
      <p className="service-page-description">
        No matter where you’re immigrating from, we provide a number of services
        to help newcomers feel welcome and settle into their new home. Tap to
        learn more about any of the following services and resources available
        to you as a new Calgarian.
      </p>
      <div className="service-buttons">
        <div className="button-row">
          ...
          <Button to="./activities" icon={<FontAwesomeIcon icon={faBicycle} />}>
            Activities
          </Button>
        </div>
